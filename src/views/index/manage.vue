      ...
      <el-menu :collapse="isCollapse">
        ...
        <router-link to="articles">
          <el-menu-item index="1">
            <i v-if="isCollapse" class="el-icon-notebook-2"></i>
            <template #title
              ><i class="el-icon-notebook-2"></i><span>文章管理</span></template
            >
          </el-menu-item>
        </router-link>
        ...
        <router-link to="tags">
          <el-menu-item index="3">
            ...
            <template #title
              ><i class="el-icon-price-tag"></i><span>标签管理</span></template
            >
          </el-menu-item>
        </router-link>
        ...
        <router-link to="link">
          <el-menu-item index="4">
            <div v-if="isCollapse"><i class="el-icon-share"></i></div>
            <template #title
              ><i class="el-icon-share"></i><span>链接管理</span></template
            >
          </el-menu-item>
        </router-link>
      </el-menu>
